...
function Greetings(props) {
  if (props.userName) {
    return (
      <div className="alert alert-light black" role="alert">
        Welcome, <b>{props.userName}</b>, you can practice typing below, or
        start learning how to type.
      </div>
    );
  }
  ...
  return (
    <div className="jumbotron">
      ...
      <hr className="my-4" />
      <p>You can start typing train immediately</p>
    </div>
  );
}
        ...
        <div>
          <BrowserRouter>
            <div className="container">
              <HeaderWithRouter
                data={this.state}
                logoutHandler={this.props.user.logoutHandler}
                errorMsg={this.props.user.state.errorMsg}
              />
              <Route
                exact
                path="/"
                render={(props) => (
                  <div>
                    ...
                    <SingleTest {...props} isLoggedIn={true} />
                  </div>
                )}
              />
              <Route
